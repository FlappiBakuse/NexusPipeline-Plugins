function discover() {
  ...
  behavior(plan, config, ['SERVER_TYPE', 'TIMETABLE_TASK', 'WANTED_HIGHEST_LEVEL', 'SPECIAL_HIGHTEST_LEVEL', 'EXCHANGE_HIGHEST_LEVEL',
    ...
    'RETRY_WHEN_ERROR', 'RETRY_WHEN_ERROR_FROM_LAST_TASK', 'CLOSE_GAME_FINISH', 'CLOSE_EMULATOR_FINISH', 'CLOSE_BAAH_FINISH', 'POST_COMMAND', 'SMART_TIMETABLE', 'CRAFT_TIMES', 'CRAFT_USE_QUICK',
