...
'use strict';
const ADAPTER = {"id":"task-protocol-legacy","preset":"json-id-array","protocolVersion":"1.0"};
if (input.phase !== "observe") throw new Error("protocol_error: wrong phase");
if (input.protocolVersion !== "1.0") throw new Error("protocol_error: wrong version");
