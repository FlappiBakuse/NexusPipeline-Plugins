...
'use strict';
const ADAPTER = {"id":"task-protocol-json-map","preset":"json-map","protocolVersion":"1.1","taskTextKeys":{"daily-reward":"task.daily_reward"},"reasonTexts":{"example.task.start":"示例任务已开始","example.task.ok":"示例任务已完成","example.task.fail":"示例任务报告失败"}};
