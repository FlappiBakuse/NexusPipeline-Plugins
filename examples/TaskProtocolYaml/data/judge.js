...
'use strict';
const ADAPTER = {"id":"task-protocol-yaml","preset":"yaml","protocolVersion":"0.1.0","taskTextKeys":{"daily-reward":"task.daily_reward"},"reasonTexts":{"example.task.start":"示例任务已开始","example.task.ok":"示例任务已完成","example.task.fail":"示例任务报告失败"},"configRules":[{"id":"example.configuration","required":true,"criticality":"advisory_or_contextual"}]};
